...
public class Test {
	...
	public static void main(String[] args) {
		ConsoleIO.println("This is the client proxy");
		...
		try {
			if (args.length == 2) {
				...
				proxy = new HerobrineProxy(proxyHost, proxyPort, spsHost, spsPort);
		...
		if(proxy != null) {
			...
			ConsoleIO.println("Herobrine client proxy is running...");
	...
	public static void printUsageMessage() {
		ConsoleIO.println("Herobrine client Proxy v1.11.2a");
		ConsoleIO.println("-------------------------");
